...
router.post(
	...
	async (req, res) => {
		if (
			!Object.prototype.hasOwnProperty.call(req.body, 'application_round_id') ||
			!Object.prototype.hasOwnProperty.call(req.body, 'email') ||
			!Object.prototype.hasOwnProperty.call(req.body, 'cnic')
		) {
			res.sendStatus(400)
			return
		}
...
router.post(
	...
	async (req, res) => {
		...
		try {
			...
			for (const key in Application.rawAttributes) {
				obj[key] = Object.prototype.hasOwnProperty.call(req.body, key)
					? req.body[key]
					: null
			}
