...
test.skip("Create Application Round", async () => {
...
test.skip("Application Form opens", async () => {
  await logout(page);
...
test.skip("Filling step 1 with an existing account but wrong cnic number should show error message", async () => {
...
test.skip("Filling step 1 with an existing account but wrong email address should show error message", async () => {
...
test.skip("Filling step 1 with an existing account correctly should show Step 2", async () => {
  // Filling correct cnic number but wrong email address
