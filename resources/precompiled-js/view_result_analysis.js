...
const percentage_ranges = percentage_ranges_field_text.split(", "); // result is an array [1,2,3,...] where 1 is no. of students with percentage between 0.00% and 10.00%, 2, and so on

const percentage_ranges_chart = new Chart(document.getElementById("percentage_ranges_chart"), {
  type: "bar",
  data: {
...
const solved_complete_vs_unsolved = new Chart(document.getElementById("num_students_chart"), {
  type: "pie",
  data: {
...
const num_other = document.getElementById("num_other").value; // Gender chart
