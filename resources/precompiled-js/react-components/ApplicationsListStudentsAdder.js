const ApplicationsListStudentsAdder = props => {
  ...
  const assignQuizToSelectedStudents = () => {
    setLoading(true);
    let list_of_student_ids_to_be_added = filtered_applications.filter(application => !application.Student.already_added && application.Student.added).map(application => [application.Student.id, application.id]);
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => {
      if (filtered_applications.map(application => application.Student).filter(student => student.added).length > 0) setShowEmailComposer(cur => !cur);else alert("You haven't selected any new students.");
    },
    ...
    users: applications.map(application => application.Student).filter(student => student.added),
    sending_link: `/quiz/send-emails/${props.quiz_id}`,
    applications: applications.filter(application => application.Student.added),
    default_values: {
  ...
  }, filters.map((filter, filter_index) => /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", null, filter.type), /*#__PURE__*/React.createElement("select", {
    ...
    className: "p-2"
  }, filter.modes.map((filter_mode, filter_mode_index) => [/*#__PURE__*/React.createElement("option", {
    value: filter_mode_index
  }, filter_mode.text)]))))), /*#__PURE__*/React.createElement("p", null, filtered_applications.length, " rows"), /*#__PURE__*/React.createElement("table", {
    ...
    type: "checkbox",
    onChange: e => {
      setFilteredApplications(cur => cur.map(app => {
  ...
  }, true) == false ? "Select All" : "Unselect All"), /*#__PURE__*/React.createElement("th", null, "Name"), /*#__PURE__*/React.createElement("th", null, "Gender"), /*#__PURE__*/React.createElement("th", null, "Email"), /*#__PURE__*/React.createElement("th", null, "Phone"), /*#__PURE__*/React.createElement("th", null, "CNIC"), /*#__PURE__*/React.createElement("th", null, "Action"))), /*#__PURE__*/React.createElement("tbody", null, filtered_applications.map((application, index) => /*#__PURE__*/React.createElement("tr", {
    key: application.id,
