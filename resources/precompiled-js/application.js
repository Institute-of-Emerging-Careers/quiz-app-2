...
function handleForm(e) {
  ...
  fetch($("#application-form").attr("action"), {
    ...
    if (raw_response.ok) {
      ...
      alert("You have already applied for this cohort before. You cannot apply again.");
...
$(document).ready(function () {
  ...
  if ($('input:radio[name="is_employed"]').is(":checked") && $('input:radio[name="is_employed"]').val() == "1") {
