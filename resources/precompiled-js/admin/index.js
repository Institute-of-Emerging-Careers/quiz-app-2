...
var QuizTile = function QuizTile(_ref) {
  var quiz = _ref.quiz;

  var _React$useState = React.useState(quiz.sendReminderEmails),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      reminderEmailsEnabled = _React$useState2[0],
      setReminderEmailsEnabled = _React$useState2[1];
  ...
  var toggleReminderEmailSetting = React.useCallback(function () {
    var data_to_send = {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: function onClick() {
      return setDropdownOpen(function (cur) {
        return !cur;
      });
    }
    ...
    onClick: function onClick() {
      return toggleReminderEmailSetting(quiz.id, quiz.sendReminderEmails, setReminderEmailsEnabled);
    }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("/admin/all-quizzes");
