...
$(document).ready(function () {
	...
	const name_mirror = $('#name-mirror')
	const email_mirror = $('#email-mirror')
	const phone_mirror = $('#phone-mirror')
	const cnic_mirror = $('#cnic-mirror')
	const gender_mirror = $('#gender-mirror')
	const age_mirror = $('#age-mirror')
	const city_mirror = $('#city-mirror')
	const address_mirror = $('#address-mirror')
	const back_arrow = $('#back-arrow')

	const firstname_field = $('#firstName')
	const lastname_field = $('#lastName')
	const email_field = $('#email')
	const cnic_field = $('#cnic')
	...
	const password_retype = $('#password2')

	const name_to_field_obj = {
	...
	$('#section1-button').click(function () {
		// getting the values
		const firstname = firstname_field.val()
		const lastname = lastname_field.val() || ''
		const email = email_field.val()
		const cnic = cnic_field.val()
		const phone = phone_field.val()
		const gender = gender_field.val()
		const age = age_field.val()
		const city = city_field.val().toUpperCase()
		const address = address_field.val().toUpperCase()
		...
		// validating input
		const firstname_validation = validateFirstname(firstname)
		const lastname_validation = validateLastname(lastname)
		const email_validation = validateEmail(email)
		const cnic_validation = validateCNIC(cnic)
		const phone_validation = validatePhone(phone)
		const gender_validation = validateGender(gender)
		const age_validation = validateAge(age)
		const city_validation = validateCity(city)
		const address_validation = validateAddress(address)
