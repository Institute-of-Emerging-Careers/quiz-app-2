...
const PassageQuestionPrompt = (props) => {
	...
	const [, setListOfQuestions] = useState('')
...
const Main = () => {
	...
	const [displayQuestions] = displayQuestionsObj
	...
	function saveQuizProgress() {
		...
		return new Promise((resolve, reject) => {
			$.ajax({
				...
				data: JSON.stringify({ sectionId, answers }),
				dataType: 'json',
...
const Header = () => {
	const { displayQuestionsObj } = useContext(MyContext)
	const [, setDisplayQuestions] = displayQuestionsObj
