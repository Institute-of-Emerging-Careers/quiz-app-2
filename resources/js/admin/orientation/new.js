...
const EmailForm = () => {
	const { orientation_id_object, students_object } = useContext(MyContext)
	const [orientation_id] = orientation_id_object
...
const NameForm = () => {
	...
	const [meeting_data] = meeting_data_object

	const [, setOrientationId] = orientation_id_object
			...
			<div className="w-full flex justify-around">
				<div>
					...
					<input
						...
						onChange={(e) => {
							setMeetingData((cur) => {
								const copy = { ...cur, zoom_link: e.target.value }
								return copy
							})
						}}
					></input>
