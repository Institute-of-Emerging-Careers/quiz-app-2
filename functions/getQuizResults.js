...
const getQuizResults = (quiz_id) => {
	return new Promise(async (resolve, reject) => {
		try {
			...
			const quiz_sections = []
			const section_id_to_array_index_mapping = {}
